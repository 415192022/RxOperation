...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<FreshDownloadView> {
     ...
     */
    private void shouldInitProperties(FreshDownloadView child, View dependency) {
