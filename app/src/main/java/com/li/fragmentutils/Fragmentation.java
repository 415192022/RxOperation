...
/**
 * Controller
 * Created by Mingwei Li on 16/1/22.
 */
...
//    static final String ARG_RESULT_BUNDLE = "fragmentation_arg_bundle";
    ...
    private Fragmentation(SupportActivity activity) {
        this.mActivity = activity;
        mHandler = mActivity.getHandler();
    }
    private static Fragmentation fragmentation=null;
     ...
     * @return
     */
    public static Fragmentation getInstance(SupportActivity activity){
        if(null == fragmentation){
            synchronized (Fragmentation.class){
                if(null == fragmentation){
                    fragmentation=new Fragmentation(activity);
                }
            }
        }
    ...
    public void startWithPop(FragmentManager fragmentManager, SupportFragment from, SupportFragment to) {
    ...
    public List<DebugFragmentRecord> getFragmentRecords() {
